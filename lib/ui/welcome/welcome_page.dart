...
class WelcomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<Preferences>(
        future: GetIt.I.getAsync<Preferences>(),
        builder: (context, snapshot) {
          validateUserAuth(context, snapshot);
          return Scaffold(
              body: Stack(
            children: [
              Image(
  ...
  void validateUserAuth(BuildContext context, AsyncSnapshot<Preferences> snapshot) {
    if (snapshot.data?.getProfile() != null) {
